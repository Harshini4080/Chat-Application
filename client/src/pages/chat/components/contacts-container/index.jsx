...
const ContactsContainer = () => {
  // Accessing global store state and setters
  const {
  ...
  // Fetch DM contacts on component mount
  useEffect(() => {
  ...
  // Main sidebar layout: Logo → DM list → Channel list → Profile info
  return (
...
// Title component for section headers (DMs, Channels)
const Title = ({ text }) => {
  return (
