...
const MessageBar = () => {
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 gap-6 mb-5">
      <div className="flex-1 flex bg-[#2a2b3] rounded-md items-center gap-5 pr-5">
        <input
          type="text"
      ...
      <button
        className="bg-[#008080] rounded-md flex items-center justify-center p-5 gap-2 focus:border-none focus:outline-none hover:bg-[#006666] focus:bg-[#20B2AA] transition-all duration-300 "
